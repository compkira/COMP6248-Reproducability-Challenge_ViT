...
class ViT(nn.Module):
    def __init__(self, image_size, patch_size, feature_dim, depth, num_heads, representation_size, classifier, num_classes, qkv_bias=True, hidden_dim_ratio=4.0, dropout_rate=0.0):
        ...
        self.transformer = Transformer(depth, feature_dim, num_heads, qkv_bias, hidden_dim_ratio, dropout_rate)
        self.classifier = classifier
        self.mlp_head = MLPHead(representation_size, feature_dim, num_classes)
